 ...
 *
 * The following middlewares work assuming that there is some data in the `res.data` object.
 * So, using the middleware in `tokenValidation.js` the `res` object is modified and the `res.data` object is populated with the user data.
 */
